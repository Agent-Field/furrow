...
Independent developers running several coding agents or terminal workflows against one project. They open Mission Control while work is active to see complete local restore points, isolated universes, shared-path collisions, and the exact operations available to converge or recover the workspace.
...
Exact, composed, and technically candid. The product should feel like a mature native developer tool: quiet under normal operation, direct when state requires attention, and confident enough to show costs, limitations, and identifiers without decoration.
...
5. Keep the local product whole. Assets are bundled, workflows work offline, and hosted account concerns never enter Mission Control.

## Accessibility & Inclusion

Target WCAG 2.2 AA. All workflows must be keyboard operable with visible focus, state cannot rely on color alone, dialogs must use native semantics, motion must respect reduced-motion preferences, and text/control sizing must remain usable at 200% zoom and narrow mobile widths.
